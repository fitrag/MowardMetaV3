...
const navigation = [
  ...
  { to: '/admin/providers', label: 'AI Providers', icon: CpuChipIcon },
  { to: '/admin/packages', label: 'Packages', icon: ShoppingBagIcon },
  { to: '/admin/payment-methods', label: 'Payment Methods', icon: CreditCardIcon },
