const schemaStatements = [
  ...
  `CREATE TABLE IF NOT EXISTS user_subscriptions (
    ...
    package_type TEXT NOT NULL CHECK(package_type IN ('credit','duration','byok','hybrid')),
    status TEXT NOT NULL DEFAULT 'active' CHECK(status IN ('active','expired','cancelled','completed','paused')),
